...
class frontendController extends Controller
{
    ...
    //Frontend Categorory Post show//
        ...
        $user_role = $this->subsUser();
        return view('frontend.category_view',compact('user_role','allpost','posts','catdata','category','data','post'));
    }
    ...
    //Frontend Sub_Category post view//
        ...
        $category = Category::with('categories')->latest()->get();
        $user_role = $this->subsUser();
        return view('frontend.category_view',compact('user_role','posts','catdata','category','data','post'));
    ...
    // single_block_post show//
        ...
        $catdata = Category::with('categories')->get();
        return view('frontend.singleblock',compact('user_role','category','postdata','catdata'));
    }
    ...
    //Contact user//
        ...
        public function contact(){
            ...
            $catdata = Category::with('categories')->get();
        return view('frontend.contact', compact('category','catdata'));
    }
