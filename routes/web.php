...
//GOOGLE LGIN ROUTE//
Route::get('/google/login',[socialController::class, 'google_login'])->name('google.login');
Route::get('/google/redirect',[socialController::class, 'google_redirect'])->name('google.redirect');

//FACEBOOK LOGIN ROUTE//
Route::get('/facebook/login',[socialController::class, 'facebook_login'])->name('facebook.login');
Route::get('/facebook/redirect',[socialController::class, 'facebook_redirect'])->name('facebook.redirect');

//FACEBOOK LOGIN ROUTE//
Route::get('/github/login',[socialController::class, 'github_login'])->name('github.login');
Route::get('/github/redirect',[socialController::class, 'github_redirect'])->name('github.redirect');
